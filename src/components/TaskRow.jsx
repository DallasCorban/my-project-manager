    ...
    >
      ...
      <div className="px-3 pb-2">
        <input
          ...
          className={`w-full h-8 px-2.5 rounded-md text-xs outline-none border ${
            darkMode ? "bg-[#0f1224] border-[#323652] text-gray-200 placeholder-gray-500" : "bg-gray-50 border-gray-300 text-gray-700 placeholder-gray-400"
          }`}
        />
      </div>
      ...
      <button
        ...
        className={`w-full px-4 py-2.5 text-[11px] font-semibold border-t flex items-center gap-2 transition-colors ${
          darkMode ? "border-[#323652] text-blue-300 hover:bg-[#0f1224]" : "border-gray-100 text-blue-600 hover:bg-gray-50"
        }`}
        type="button"
      >
...
export default function TaskRow({
  ...
  const containerStyle = isRowDragging
    ...
    : `flex border-b transition-colors items-center h-10 relative group ${
        darkMode ? "border-[#323652] hover:bg-[#202336] bg-[#1c213e]" : "border-[#eceff8] hover:bg-[#f0f0f0] bg-white"
      }`;
  ...
  return (
    ...
    >
      ...
      <div
        className={`border-r h-full flex items-center px-4 relative min-w-0 ${darkMode ? "border-[#323652]" : "border-[#eceff8]"}`}
      ...
      {activeTab === "board" && (
        <>
          <div
            className={`border-r h-full flex items-center justify-center min-w-0 ${darkMode ? "border-[#323652]" : "border-[#eceff8]"}`}
          ...
          <div
            className={`border-r h-full flex items-center justify-center px-2 relative min-w-0 ${darkMode ? "border-[#323652]" : "border-[#eceff8]"}`}
