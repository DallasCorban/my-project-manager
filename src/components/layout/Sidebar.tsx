...
export function Sidebar({
    ...
    return (
      <div
        className={`w-12 border-r flex flex-col items-center py-4 shrink-0 hidden md:flex ${
          darkMode ? 'bg-[#111322] border-[#2a2d44]' : 'bg-[#f7f7f9] border-[#d0d4e4]'
        }`}
      >
        <button
  ...
  return (
    ...
    >
      {/* Workspace header */}
      <div className={`px-4 py-3 border-b ${darkMode ? 'border-[#2a2d44]' : 'border-[#d0d4e4]'}`}>
        ...
        {showWorkspaces && (
          <div className={`mt-2 rounded-lg border overflow-hidden ${
            darkMode ? 'bg-[#1c213e] border-[#2a2d44]' : 'bg-white border-gray-200'
          }`}>
            {workspaces.map((ws) => (
              <div
                key={ws.id}
            ...
            <div
              ...
              className={`px-3 py-2 text-xs cursor-pointer flex items-center gap-1.5 border-t transition-colors ${
                darkMode
                  ? 'border-[#2a2d44] text-gray-400 hover:bg-white/5'
      ...
      >
        ...
        <button
          ...
          className={`p-1.5 rounded-lg transition-colors ${
            darkMode ? 'bg-[#2a2d44] text-yellow-400 hover:bg-[#3a3b44]' : 'bg-gray-100 text-gray-500 hover:bg-gray-200'
          }`}
