      ...
      >
        <div
          className={`w-80 border-r p-3 font-medium text-sm pl-6 sticky left-0 z-[200] flex-shrink-0 ${
            darkMode
              ? "bg-[#1c213e] border-[#323652] text-gray-300"
        ...
        <div className="flex flex-col flex-1">
          <div className={`flex h-8 border-b ${darkMode ? "border-[#323652]" : "border-[#eceff8]"}`}>
      ...
      <div style={{ width: `calc(20rem + ${visibleDays.length * zoomLevel}px)` }}>
        {visibleProjects.map((project) => {
          ...
          return (
            <div
              key={project.id}
              className={`border-b group/project ${darkMode ? "border-[#323652] bg-[#181b34]" : "border-[#eceff8] bg-white"}`}
            >
              <div
                className={`flex border-b ${darkMode ? "border-[#323652]" : "border-[#eceff8]"}`}
              ...
              >
                <div
                  className={`w-80 border-r px-4 sticky left-0 z-[200] flex items-center gap-2 flex-shrink-0 ${
                    darkMode ? "border-[#323652] bg-[#151726] text-gray-200" : "border-[#bec3d4] bg-[#f9fafc] text-gray-800"
                  }`}
                >
                    ...
                    >
                      <div
                        className={`w-80 border-r px-4 flex items-center gap-2 sticky left-0 z-[200] cursor-pointer flex-shrink-0 transition-colors ${
                          darkMode ? "border-[#323652] text-gray-200" : "border-[#bec3d4] text-gray-700"
                        }`}
                            ...
                            >
                              <div
                                className={`w-80 border-r flex-shrink-0 sticky left-0 z-[200] ${
                                  darkMode
                                    ? "border-[#323652] bg-inherit text-gray-300"
                                ...
                                return (
                                  <div
                                    ...
                                    className={`flex h-10 items-center border-t relative ${
                                      darkMode ? "border-[#323652] hover:bg-[#202336]" : "border-[#eceff8] hover:bg-[#eceff8]"
                                    }`}
                                  >
                                    <div
                                      className={`w-80 border-r flex-shrink-0 sticky left-0 z-[200] ${
                                        darkMode
                                          ? "border-[#323652] bg-inherit text-gray-400"
