  ...
  return (
    <div
      ...
      className={`flex-1 overflow-auto overflow-x-auto relative border-t ${
        darkMode ? "bg-[#181b34] border-[#343856]" : "bg-white border-[#bec3d4]"
      }`}
    >
      <div
      ...
      >
        <div
          className={`w-80 border-r p-3 font-medium text-sm pl-6 sticky left-0 z-[200] flex-shrink-0 ${
            darkMode
              ? "bg-[#1c213e] border-[#343856] text-gray-300"
      ...
      <div style={{ width: `calc(20rem + ${visibleDays.length * zoomLevel}px)` }}>
        {visibleProjects.map((project) => {
          ...
          return (
            <div
              key={project.id}
              className={`border-b group/project ${darkMode ? "border-[#343856] bg-[#181b34]" : "border-[#eceff8] bg-white"}`}
            >
              <div
                className={`flex border-b ${darkMode ? "border-[#343856]" : "border-[#eceff8]"}`}
              ...
              >
                <div
                  className={`w-80 border-r px-4 sticky left-0 z-[200] flex items-center gap-2 flex-shrink-0 ${
                    darkMode ? "border-[#343856] bg-[#151726] text-gray-200" : "border-[#bec3d4] bg-[#f9fafc] text-gray-800"
                  }`}
                >
                    ...
                    >
                      <div
                        className={`w-80 border-r px-4 flex items-center gap-2 sticky left-0 z-[200] cursor-pointer flex-shrink-0 transition-colors ${
                          darkMode ? "border-[#343856] text-gray-200" : "border-[#bec3d4] text-gray-700"
                        }`}
                            ...
                            >
                              <div
                                className={`w-80 border-r flex-shrink-0 sticky left-0 z-[200] ${
                                  darkMode
                                    ? "border-[#343856] bg-inherit text-gray-300"
                                ...
                                return (
                                  <div
                                    ...
                                    className={`flex h-10 items-center border-t relative ${
                                      darkMode ? "border-[#343856] hover:bg-[#202336]" : "border-[#eceff8] hover:bg-[#eceff8]"
                                    }`}
                                  >
                                    <div
                                      className={`w-80 border-r flex-shrink-0 sticky left-0 z-[200] ${
                                        darkMode
                                          ? "border-[#343856] bg-inherit text-gray-400"
