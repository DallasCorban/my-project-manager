...
export function UpdatesPanel({
  ...
  return (
    <div className={`h-full w-full flex flex-col ${darkMode ? 'bg-[#111322] text-gray-200' : 'bg-[#f7f7f9] text-gray-800'}`}>
      ...
      {/* ── Header ── */}
      <div className={`flex items-start gap-3 px-4 py-3.5 border-b shrink-0 ${darkMode ? 'border-[#343856]' : 'border-[#bec3d4]'}`}>
      ...
      {/* ── Tabs ── */}
      <div className={`flex border-b shrink-0 ${darkMode ? 'border-[#343856]' : 'border-[#bec3d4]'}`}>
      ...
      {/* ── Read-only notice ── */}
      {!canEdit && (
        <div className={`px-4 py-2 text-xs shrink-0 ${darkMode ? 'bg-amber-500/10 text-amber-400 border-b border-[#343856]' : 'bg-amber-50 text-amber-600 border-b border-[#bec3d4]'}`}>
      ...
      {activeTab === 'updates' && (
        <>
          ...
          {canEdit && (
            <div className={`shrink-0 border-b ${darkMode ? 'border-[#343856] bg-[#0d0f23]' : 'border-[#bec3d4] bg-[#f2f4fb]'}`}>

              {/* Formatting toolbar */}
              <div className={`flex items-center flex-wrap gap-0.5 px-3 py-2 border-b ${darkMode ? 'border-[#343856]' : 'border-[#bec3d4]/80'}`}>
                ...
                <div className="relative" data-picker>
                  ...
                  {showColorPicker && (
                    <div data-picker className={`absolute top-full left-0 mt-1 p-2 rounded-xl shadow-2xl border z-50 ${darkMode ? 'bg-[#0b0d1c] border-[#343856]' : 'bg-white border-gray-300'}`}>
                ...
                <div className="relative" data-picker>
                  ...
                  {showSizePicker && (
                    <div data-picker className={`absolute top-full left-0 mt-1 rounded-xl shadow-2xl border z-50 overflow-hidden min-w-[100px] ${darkMode ? 'bg-[#0b0d1c] border-[#343856]' : 'bg-white border-gray-300'}`}>
                      {FONT_SIZES.map((s) => (
                        <button
                          key={s.value}
              ...
              {/* Link URL input bar */}
              {showLinkInput && (
                <div className={`flex items-center gap-2 px-3 py-2 border-b ${darkMode ? 'border-[#343856]' : 'border-[#bec3d4]/80'}`}>
              ...
              {/* Inline checklist */}
              {showChecklist && (
                <div className={`px-4 py-2.5 border-t ${darkMode ? 'border-[#343856]' : 'border-[#bec3d4]/80'}`}>
              ...
              {/* Composer bottom bar */}
              <div className={`flex items-center gap-1 px-3 py-2 border-t ${darkMode ? 'border-[#343856]' : 'border-[#bec3d4]/80'}`}>
                {onUploadFile && (
                  <button
...
function UpdateCard({
  ...
  return (
    <div className={`rounded-xl border ${darkMode ? 'bg-[#161a32] border-[#343856]' : 'bg-white border-gray-100 shadow-sm'}`}>
      {/* Card header */}
      ...
      <div className="px-3.5 pb-3">
        ...
        {update.replies && update.replies.length > 0 && (
          <div className={`mt-2.5 pt-2.5 border-t space-y-2.5 ${darkMode ? 'border-[#343856]' : 'border-gray-100'}`}>
        ...
        {canEdit && (
          <div className="mt-2.5">
            {replyingTo === update.id ? (
              <div className={`flex items-center gap-2 rounded-lg px-3 py-2 ${darkMode ? 'bg-[#07080f] border border-[#343856]' : 'bg-gray-50 border border-gray-300'}`}>
                <input
                  value={replyText}
        ...
        {canUpload && onAddFiles && (
          <button
            ...
            className={`flex-1 flex items-center justify-center gap-2 px-4 py-3 rounded-xl border-2 border-dashed text-sm font-medium transition-colors ${
              darkMode
                ? 'border-[#343856] text-gray-500 hover:border-blue-500/50 hover:text-blue-400 hover:bg-blue-500/5'
            ...
            <div
              ...
              className={`flex items-center gap-3 p-2.5 rounded-xl border ${
                task.status === 'error'
                  ...
                  : darkMode ? 'border-[#343856] bg-[#161a32]' : 'border-gray-100 bg-gray-50'
              }`}
            >
          ...
          {files.map((file) => (
            <div
              ...
              className={`rounded-xl border overflow-hidden flex flex-col ${
                darkMode ? 'bg-[#161a32] border-[#343856]' : 'bg-white border-gray-100 shadow-sm'
              }`}
            >
              {/* Preview area */}
